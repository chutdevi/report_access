...
! function(a) {
    ...
    function r1() {
        var b = a("#demo-select2-10");
        b.select2({
            dir: "ltr"
        })
    }
    function r2() {
        var b = a("#demo-select2-11");
        b.select2({
            dir: "ltr"
        })
    }
    function r3() {
        var b = a("#demo-select2-12");
        b.select2({
            dir: "ltr"
        })
    }
    function r4() {
        var b = a("#demo-select2-13");
        b.select2({
            dir: "ltr"
        })
    }	
    function r5() {
        var b = a("#demo-select2-14");
        b.select2({
            dir: "ltr"
        })
    }	
    function r6() {
        var b = a("#demo-select2-15");
        b.select2({
            dir: "ltr"
        })
    }	
    function r7() {
        var b = a("#demo-select2-16");
        b.select2({
            dir: "ltr"
        })
    }	
    function r8() {
        var b = a("#demo-select2-17");
        b.select2({
            dir: "ltr"
        })
    }		
    ...
    function Q() {
        var b = a("#indt-datatables-scroller-1");
		//btl = b;
    ...
    QM(),r1(),r2(),r3(),r4(),r5(),r6(),r7(),r8(), b(), c(), d(), e(), f(), g(), h(), i(), j(), k(), l(), m(), n(), o(), p(), q(), r(), s(), t(), u(), v(), x(), y(), z(), A(), B(), C(), E(), G(), I(), L(), M(), N(), O(), P(), Q(), R(), S(), T(), U(), V(), W(), X(), Y(), Z(), $(), _(), aa(), ba(), ca(), da(), ea(), fa(), ga(), ha(), ia(), ja(), ka(), la(), ma(), na(), a("button.theme-panel-toggler").one("click", oa)
}(jQuery);
