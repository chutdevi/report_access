...
var months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];	
	if( $('#chart_9').length > 0 ){
		...
		var data2 = {
			...
			datasets: [
				...
				{
					label: months[d.getMonth()+2],
					fill: false,
					borderColor: "#ff3300",
					data: chart_data3
				},
				{
					label: months[d.getMonth()+3],
					fill: false,
					borderColor: "#333300",
					data: chart_data4
				},
				{
					label: months[d.getMonth()+4],
					fill: false,
					borderColor: "#666EE8",
					data: chart_data5
				}
	...
	if( $('#chart_9A').length > 0 ){
		var ctx2 = document.getElementById("chart_9A").getContext("2d");
		//alert(ob.ke);
		var data2 = {
