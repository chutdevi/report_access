  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data interface to A.S.I.A (Purchase)    
      </h1>
    </section> 
...
<!--   <div class="col-4 ">      
     ...
     <div class="box-body">
        <form action="http://192.168.161.102/excel_gen/csv/pu" class="novalidate" method="post" accept-charset="utf-8" onsubmit="myAll()">
  ...
  <div class="col-6 ">      
     ...
     <div class="box-body">
        <form action="http://192.168.161.102/excel_gen/csv/pu" class="novalidate" method="post" accept-charset="utf-8" onsubmit="myDom()">
  ...
  <div class="col-6 ">      
     ...
     <div class="box-body">
        <form action="http://192.168.161.102/excel_gen/csv/pu" class="novalidate" method="post" accept-charset="utf-8" onsubmit="myOve()">
