     ...
     <!-- Basic Forms -->
      <div class="box">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
              <form action="http://192.168.161.102/excel_gen/Report/purchase" class="novalidate" method="post" accept-charset="utf-8">
                <div class="row">
                  ...
                  <div class="box-footer col-lg-12 col-lg-6 col-12 ">
                      ...
                      <button  type="submit" class="btn btn-social btn btn-primary mb-5" name="ty_data" value="2" ><i class="fa fa-file-excel-o"  ></i> EXPORT DOMESTICS DATA TO EXCEL FILE </button>

                      <button  type="submit" class="btn btn-social btn btn-pink mb-5"    name="ty_data" value="3" ><i class="fa fa-file-excel-o"  ></i> EXPORT OVERSEA DATA TO EXCEL FILE </button>
