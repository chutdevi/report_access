<style type="text/css">
    ...
    @media (max-width : 1400px){  .modalspan6  {  margin-left: 6%; font-size: 7px;  margin-top: 5%;  }}
    @media (max-width : 1900px){  .modalspan4  {  margin-left: 6%; font-size: 9px; margin-top: 2%;  }}
...
<div class="modal fade" id="myModal-<? echo strtolower($inx);?>" role="dialog"> 
