...
public function summary_cost_rm($table)
{
    ...
    $sqlJb = "
              ...
              (SELECT RM.SOURCE_NAME, BC.REF, BC.PARENT_ITEM, BC.COMP_ITEM, BC.UNIT_USE, BC.UNIT, RM.UNIT_COST, RM.CUR_CD, (BC.UNIT_USE * RM.UNIT_COST) SUM_COST, ROUND(RM.UNIT_COST * 0.294341236, 2) MUL_RATE, ROUND( ROUND(RM.UNIT_COST * 0.294341236,2) * BC.UNIT_USE, 2) RATE_TOTAL   FROM BOM_COMP BC LEFT OUTER JOIN ROYALTY_TBK_RM RM ON BC.COMP_ITEM = RM.ITEM_CD WHERE RM.SOURCE_CD = 'T00100') BC
